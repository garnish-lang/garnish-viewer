import type {BuildInfo, ExecutionInfo, RuntimeData, ViewerContext} from "./garnish_types";

export const mockExecutionData = (): ExecutionInfo => {
    return {
        context: mockContext(),
        runtime: {
...
export const mockContext = (): ViewerContext => {
    return {
        build_metadata: [
            {
...
export const mockRuntimeData = (): RuntimeData => {
    return {
        cache: {
